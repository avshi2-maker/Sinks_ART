...
export default function SuppliersReport({ suppliers, offers, customers = [] }: { suppliers: SupplierRow[]; offers: SupplierOfferRow[]; customers?: CustomerPick[] }) {
  ...
  function customerOfferText(o: SupplierOfferRow, f: FinalizeState): string {
    const custTotal = computeCustomerTotal(o.total_ils, f.commType, f.commValue);
  ...
  async function saveFinalize(o: SupplierOfferRow) {
    setBusy(o.id);
    const custTotal = computeCustomerTotal(o.total_ils, fin.commType, fin.commValue);
