...
import { fetchSuppliers, fetchSupplierOffers } from '@/lib/suppliers/suppliersData';
import SuppliersReport from '@/components/suppliers/SuppliersReport';

export const dynamic = 'force-dynamic';

export default async function SuppliersPage() {
  const [suppliers, offers] = await Promise.all([fetchSuppliers(), fetchSupplierOffers()]);
  return (
    <div className="max-w-4xl mx-auto p-4" dir="rtl">
      ...
      <SuppliersReport suppliers={suppliers} offers={offers} />
    </div>
  );
}
