...
export default async function SuppliersPage() {
  const [suppliers, offers, customers] = await Promise.all([fetchSuppliers(), fetchSupplierOffers(), fetchCustomersForOffer()]);
  return (
    <div className="max-w-4xl mx-auto p-4" dir="rtl">
      ...
      <SuppliersReport suppliers={suppliers} offers={offers} customers={customers} />
    </div>
  );
}
